        ...
        private void btn_Submit_Click(object sender, EventArgs e)
        {
            ...
            if (tb_Emp_Name.Text != "")
            {
                ...
                if (cmb_Emp_Dept.Text != "")
                {
                    ...
                    {
                        Result += rb_Female.Text + " candidate. Konown Languages";
                    }
                    else if (rb_Male.Checked == true)
                    {
                        Result += rb_Male.Text + " candidate Konown Languages";
                    }
                    else
                    {
                    ...
                    else
                    {
                        ...
                        lbl_Lang_Error.Text = "Select At Least One Language.";
                        Flag = true;
                    }
                }
                else
                {
                    ...
                    lbl_Dept_Error.Text = "Select Depatment.";
                    Flag = true;
                }
            }
            else
